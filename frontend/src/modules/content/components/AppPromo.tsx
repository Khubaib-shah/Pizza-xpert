...
export default function AppPromo() {
  ...
  return (
    <section
      className="relative py-20 px-4 md:px-6 overflow-hidden bg-grain"
      style={{
        background:
          "linear-gradient(180deg, var(--color-charcoal) 0%, var(--color-burgundy) 100%)",
      }}
    >
          ...
          <div className="relative w-[280px] h-[550px] bg-charcoal rounded-[44px] p-3 shadow-[0_25px_60px_rgba(0,0,0,0.8)] border-4 border-white/10 select-none overflow-hidden animate-float-levitate">
            ...
            <div className="w-full h-full bg-charcoal-dark rounded-[36px] overflow-hidden flex flex-col justify-between p-4 relative font-sans">
              ...
              <div className="flex items-center justify-between mt-3 text-left">
                <div>
                  <div className="text-[10px] text-cream/40 uppercase font-medium tracking-wider leading-none">
                    ORDERING APP
                  </div>
                  <div className="font-display text-lg font-medium text-cheese leading-tight mt-0.5">
                    PIZZA XPERT
                  </div>
                </div>
              ...
              <div className="bg-charcoal-800/90 border border-white/5 rounded-2xl p-3 text-left space-y-2">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-[9px] text-cream/40 uppercase leading-none font-medium">
                      TOTAL SUM
                    </div>
                    <div className="text-base font-medium text-cheese mt-0.5">
                      Rs18.99
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-around bg-charcoal-900/80 py-1.5 px-3 border border-white/5 rounded-full mt-2">
                {["🏠", "🍕", "🛒", "⚙️"].map((sim, sIdx) => (
                  <span
                    key={sIdx}
                    className={`text-xs p-1 ${sIdx === 1 ? "bg-burgundy rounded-full" : ""}`}
                  >
                    {sim}
                  </span>
                ))}
        ...
        <div className="lg:col-span-7 text-left space-y-6 md:space-y-8 my-auto p-4">
          ...
          <div className="space-y-3">
            <h2 className="font-display text-4xl md:text-6xl font-medium text-white tracking-wide uppercase leading-none">
              ORDER ON{" "}
              <span className="text-cheese text-glow-gold">THE GO</span>
            </h2>
            <p className="font-sans text-cream/90 text-sm md:text-base max-w-lg leading-tight font-semibold">
              Download the official{" "}
              <b className="text-cheese">Pizza Xpert app</b>. Unlock
              hyper-interactive customizable pizza generators, secure one-swipe
              checkout protocols, and live telemetry order tracking from
              prep-table to front-yard. Fast, easy, cheesy.
            </p>
          </div>
          ...
          <div className="flex items-center gap-5">
            <div>
              ...
              <div className="text-[10px] uppercase font-medium text-cream/40 tracking-wider mt-0.5">
                App Store
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            >
              ...
              <div>
                <div className="text-[9px] uppercase tracking-wider text-cream/40 leading-none">
                  Download on
                </div>
                <div className="font-sans font-extrabold text-sm text-cream mt-0.5">
                  App Store
                </div>
              </div>
            </a>
