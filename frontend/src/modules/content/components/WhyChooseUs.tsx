...
export default function WhyChooseUs() {
  const features = [
    {
      ...
      title: "FRESH DAILY",
      description:
        "Dough fermented 48 hours for premium bubbles, made fresh every single morning by our certified master bakers.",
      stat: "48H DOUGH",
    },
    {
      ...
      description:
        "Dispatched in special induction pre-heated cases. Sizzling hot at your doorstep in under 30 minutes or it's free.",
    ...
    },
    {
      ...
      description:
        "100% premium local Wisconsin whole-milk mozzarella. No starch, no substitutes, no compromise on stretchability.",
      stat: "🥇 WISCONSIN A++",
    },
    {
      ...
      title: "5-STAR RATING",
      description:
        "Verified with Behance-grade food ratings. Over 12,000+ happy fast-food connoisseurs in the metropolitan zone.",
      stat: "12K+ HAPPY",
    },
  ];
  ...
  return (
    <section
      id="about"
      className="relative bg-charcoal-gray py-20 px-4 md:px-6"
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="font-sans text-cream/90 text-xs md:text-sm max-w-sm mx-auto font-medium uppercase tracking-wider">
            Our strict culinary bylaws guarantee gold-plated speed without
            sacrificial taste degradation.
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="font-sans text-cream/90 text-xs font-medium leading-tight">
                    {feat.description}
                  </p>
                </div>
              </div>
