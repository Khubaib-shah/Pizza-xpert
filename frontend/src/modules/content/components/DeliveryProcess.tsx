...
import { DELIVERY_STEPS } from "../../../shared/data/data";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-4 mb-20">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-medium text-white tracking-wide uppercase leading-none">
            OUR <span className="text-cheese text-glow-gold">DELIVERY</span>{" "}
            PROCESS
          </h2>
          ...
          <p className="font-sans text-cream/90 text-xs md:text-sm max-w-sm mx-auto font-medium uppercase tracking-wider">
            Chronological blueprint mapping our high-converting speed tunnel
            from oven peel to front porch.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1.5 max-w-xs text-center">
                  ...
                  <p className="font-sans text-cream/90 text-[11px] md:text-xs leading-relax font-normal">
                    {step.description}
                  </p>
                </div>
              </div>
