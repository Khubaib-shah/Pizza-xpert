...
export default function Hero({ onScrollToElement }: HeroProps) {
  const { data: landingContent, isLoading: loading } = useLandingContent();
  ...
  if (loading || slides.length === 0) {
    return (
      <section id="home" className="min-h-[90vh] flex items-center justify-center pt-24">
  ...
  return (
    ...
    <section
      id="home"
      className="relative w-full !max-h-[50vh] md:min-h-[90vh] flex flex-col justify-between pt-24 md:pt-28 overflow-hidden select-none"
    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          style={{
            backgroundImage: `url(${optimizeCloudinaryUrl(activeSlide.backgroundImg, 1920)})`,
          }}
      ...
      <div className="md:max-w-5xl lg:max-w-7xl mx-auto w-full px-4 md:px-6 grid grid-cols-12 gap-10 lg:gap-6 items-center mt-auto !mb-12 py-10 md:!pt-10 md:mb-0 md:pb-0 relative z-10">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="col-span-7 flex flex-col justify-center text-left space-y-6 md:space-y-8 z-10"
          >
            ...
            <div className="relative space-y-2">
              <div className="flex items-end gap-4 select-none">
                {/* Big Number Display */}
                <span className="text-7xl self-end sm:text-[130px] md:text-[140px] font-medium text-white leading-none tracking-wide filter drop-shadow-[0_8px_16px_rgba(0,0,0,0.6)]">
        ...
        <div className="col-span-4 relative flex items-center justify-center p-4 min-h-[180px] md:min-h-[220px] lg:min-h-0 select-none">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 flex items-center justify-center" style={{ willChange: 'transform' }}>
                ...
                {/* Content */}
                <div className="relative z-10 text-center flex flex-col justify-center items-center select-none font-display">
                  <span className="text-[10px] md:text-sm !font-normal text-cheese tracking-wide leading-none filter drop-shadow">
                    {activeSlide.pricePrefix}
                  </span>
      ...
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-3 z-30 select-none">
