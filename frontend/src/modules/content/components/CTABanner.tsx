  ...
  return (
    <section className="relative bg-burgundy bg-grain py-24 px-4 md:px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8 relative z-20 pt-10">
        ...
        {/* Subtext */}
        <p className="font-sans text-cream/90 text-sm md:text-lg max-w-lg mx-auto font-medium">
          Dough is rolled, brick oven is fired to 850°F, and our speed dispatch
          messengers are strapped on their helmets. Click below to secure hot,
          bubbling cheesiness at your front gate in 30 minutes flat.
        </p>
        ...
        <div className="pt-2">
          <button
            ...
            className="group btn-primary-anim bg-burgundy text-cheese hover:bg-tomato hover:text-cream font-sans font-medium text-base md:text-lg uppercase tracking-[3px] py-4.5 px-10 rounded-xl transition-all duration-300 border border-tomato/20 active:scale-95 inline-flex items-center gap-3 cursor-pointer"
          >
            ORDER NOW
