...
export default function CustomersDirectory({
  customers, searchQuery, setSearchQuery, selectedCustomer, setSelectedCustomer
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="text-xs uppercase text-cheese font-mono">{customers.length} ACTIVE RECORDS LOADED</div>
      </div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-charcoal p-3 rounded-xl border border-white/5">
                  ...
                  <span className="text-lg font-mono font-medium text-white">Rs{selectedCustomer.spend.toLocaleString()}</span>
                </div>
                <div className="bg-charcoal p-3 rounded-xl border border-white/5">
                  <span className="text-[10px] text-cream/40 uppercase font-mono block">Aggregate orders</span>
                  <span className="text-lg font-mono font-medium text-cheese">{selectedCustomer.orders} Meals</span>
                </div>
              </div>
